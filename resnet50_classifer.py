...
WEIGHTS_DIR = './params/resnet50'
if not os.path.exists(WEIGHTS_DIR):
    os.makedirs(WEIGHTS_DIR)

WEIGHTS_PATH = os.path.join(WEIGHTS_DIR, 'weights_resnet50.h5')
...
base_model = ResNet50(input_shape=(config.IMAGE_SIZE, config.IMAGE_SIZE, 3),
...
df_test.to_csv('./results/submission_inceptionV3_f_299.csv', index=False)
