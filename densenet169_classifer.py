...
WEIGHTS_DIR = './params/densenet169_f'
if not os.path.exists(WEIGHTS_DIR):
    os.makedirs(WEIGHTS_DIR)

WEIGHTS_PATH = os.path.join(WEIGHTS_DIR, 'weights_densenet169_f.h5')
...
df_test.to_csv('./results/submission_densenet169_f.csv', index=False)
