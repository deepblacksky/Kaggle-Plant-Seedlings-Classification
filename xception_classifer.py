...
WEIGHTS_DIR = './params/xception_f'
if not os.path.exists(WEIGHTS_DIR):
    os.makedirs(WEIGHTS_DIR)

WEIGHTS_PATH = os.path.join(WEIGHTS_DIR, 'weights_xception_f_299.h5')
...
base_model = Xception(input_shape=(config.IMAGE_SIZE, config.IMAGE_SIZE, 3),
...
df_test.to_csv('./results/submission_xception_f_299.csv', index=False)
