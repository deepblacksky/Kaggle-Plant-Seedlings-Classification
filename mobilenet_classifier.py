...
WEIGHTS_DIR = './params/mobilenet_f'
if not os.path.exists(WEIGHTS_DIR):
    os.makedirs(WEIGHTS_DIR)

WEIGHTS_PATH = os.path.join(WEIGHTS_DIR, 'weights_mobilenet_f_299.h5')
...
df_test.to_csv('./results/submission_mobilenet_f_299.csv', index=False)
