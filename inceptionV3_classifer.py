...
WEIGHTS_DIR = './params/inceptionV3'
if not os.path.exists(WEIGHTS_DIR):
    os.makedirs(WEIGHTS_DIR)

WEIGHTS_PATH = os.path.join(WEIGHTS_DIR, 'weights_inceptionV3_1_31.h5')
...
#              ReduceLROnPlateau(monitor='val_loss', factor=0.1, patience=10, verbose=1, mode='auto',
...
base_model = InceptionV3(input_shape=(config.IMAGE_SIZE, config.IMAGE_SIZE, 3),
...
df_test.to_csv('./results/submission_inceptionV3_1_31.csv', index=False)
